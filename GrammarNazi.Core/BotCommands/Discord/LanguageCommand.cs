...
public class LanguageCommand(IDiscordChannelConfigService channelConfigService) : BaseDiscordCommand, IDiscordBotCommand
{
    ...
    public async Task Handle(IMessage message)
    {
        ...
        if (parsedOk && language.IsAssignableToEnum<SupportedLanguages>())
        {
            ...
            await SendMessage(message, $"Language updated: {channelConfig.SelectedLanguage.Description}", DiscordBotCommands.Language);
